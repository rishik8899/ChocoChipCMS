package org.apache.jsp.libs.composum.nodes.usermgnt.user.groups;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class groups_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/usermgnt/user/groups/groups.jsp(6,0) name = id type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setId("user");
      // /libs/composum/nodes/usermgnt/user/groups/groups.jsp(6,0) name = type type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setType("com.composum.sling.core.usermanagement.view.User");
      // /libs/composum/nodes/usermgnt/user/groups/groups.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_005fcomponent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("    <div class=\"groups detail-panel full-table-view\">\n");
          out.write("        <div class=\"table-toolbar\">\n");
          out.write("            <div class=\"btn-group btn-group-sm\" role=\"group\">\n");
          out.write("                    <button class=\"add-authorizable-to-group fa fa-plus btn btn-default\" title=\"Add user to group\"><span class=\"label\">Add user to group</span></button>\n");
          out.write("                    <button class=\"remove-authorizable-from-group fa fa-minus btn btn-default\" title=\"Remove user from group\"><span class=\"label\">Remove user from group</span></button>\n");
          out.write("            </div>\n");
          out.write("        </div>\n");
          out.write("        <div class=\"table-container\">\n");
          out.write("            <table id=\"user-view-groups-table\" class=\"groups-table\"\n");
          out.write("                   data-path=\"");
          ...
          out.write("\"\n");
          out.write("                   data-toolbar=\".groups .table-toolbar\">\n");
          out.write("            </table>\n");
          out.write("        </div>\n");
          out.write("    </div>\n");
