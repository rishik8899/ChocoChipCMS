package org.apache.jsp.libs.composum.nodes.usermgnt.dialogs.addmember;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class add_002dmember_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(6,0) name = id type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setId("group");
      // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(6,0) name = type type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setType("com.composum.sling.core.usermanagement.view.Group");
      // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_005fcomponent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        com.composum.sling.core.usermanagement.view.Group group = null;
        ...
        group = (com.composum.sling.core.usermanagement.view.Group) _jspx_page_context.findAttribute("group");
        do {
          out.write("\n");
          out.write("    <div id=\"add-member-dialog\" class=\"dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
  ...
  private boolean _jspx_meth_cpn_005fform_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_005fcomponent_005f0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(10,16) name = classes type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_005fform_005f0.setClasses("widget-form");
    // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(10,16) name = enctype type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_005fform_005f0.setEnctype("multipart/form-data");
    // /libs/composum/nodes/usermgnt/dialogs/addmember/add-member.jsp(10,16) name = action type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_005fform_005f0.setAction("/bin/cpm/usermanagement.disable.json");
    ...
    if (_jspx_eval_cpn_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("                        <h4 class=\"modal-title\">Add authorizable to group</h4>\n");
        out.write("                    </div>\n");
        out.write("\n");
        ...
        out.write("                            <input name=\"group\" class=\"widget text-field-widget form-control\" type=\"text\"\n");
        out.write("                                   data-rules=\"mandatory\" readonly />\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\">\n");
        out.write("                            <label class=\"control-label\">Authorizable</label>\n");
        out.write("                            <input name=\"authorizable\" class=\"widget text-field-widget form-control\" type=\"text\"\n");
        out.write("                                   placeholder=\"enter authorizable\" data-rules=\"mandatory\" />\n");
        out.write("                        </div>\n");
        out.write("\n");
        out.write("                    </div>\n");
        out.write("\n");
        ...
        out.write("                        <button type=\"submit\" class=\"btn btn-primary create\">Add</button>\n");
        out.write("                    </div>\n");
        out.write("\n");
        out.write("                ");
